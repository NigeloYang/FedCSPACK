...
def generate_dataset(dir_path,args):
    ...
    trainset = torchvision.datasets.CIFAR10(
        root='local_dataset', train=True, download=True, transform=transform)
    testset = torchvision.datasets.CIFAR10(
        root='local_dataset', train=False, download=True, transform=transform)
...
if __name__ == "__main__":
    ...
    # general
    parser.add_argument('--niid', type=str, default="noniid", help="data distribution is iid/noniid")
    parser.add_argument('--partition', type=str, default="exdir", help="data distribution hete(pat/dir/exdir)")
    ...
    parser.add_argument("--class_per_client", type=int, default=2, help="class number of clients")
